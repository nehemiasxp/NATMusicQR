-- NATMusicQR: forzar IDs reales de YouTube
-- Supabase → SQL Editor → New query → pegar TODO → Run
-- Esto DESACTIVA RLS de videos un momento (solo aquí) para poder editar.
...
-- Reiniciar cola con los 4 temas reales
...
-- Dejar UPDATE permitido para el futuro (anon / authenticated)
...
-- Comprobar resultado
SELECT title, youtube_id, is_active FROM public.videos ORDER BY is_active DESC, title;
